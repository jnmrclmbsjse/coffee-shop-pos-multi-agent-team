...
your spec is ADR 0001 directly. No charter is injected into
this one-off prompt: read `charters/_shared.md` and `charters/dev.md` for
identity/boundaries, and AGENTS.md for the stack and binding conventions.
